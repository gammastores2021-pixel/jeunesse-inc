...
const COPY: Record<Locale, { sections: { h: string; p: string[] }[] }> = {
  ...
  ar: {
    sections: [
      ...
      { h: "٢. الخدمات", p: ["يصف الموقع خدمات جونيس ستورز. تحكم المشاريعَ اتفاقياتٌ مكتوبة منفصلة."] },
      {
        h: "٣. لا ضمان للنتائج",
        p: ["تعتمد نتائج الذكاء الاصطناعي والتسويق على عوامل خارج سيطرتنا. لا نضمن نتائج محدّدة."]
      },
      { h: "٤. الملكية الفكرية", p: ["محتوى الموقع ملك لجونيس ستورز أو لمرخّصيها. ممنوع نسخه أو تعديله بدون إذن."] },
